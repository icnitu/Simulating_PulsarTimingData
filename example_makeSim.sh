...
# Script showing an example on how to 
#	simulate timing noise using TEMPO2
# Iuliana Nitu, 22/09/2022
...
# -- but this can of course be any tim file you want
...
# for power-law red noise, use
Pyr3=1e-28 # this is equivalent to TNRedAmp=-12.96
aRN=-4 # note this needs to be negative
...
# -> this should give you a file called ${idealtim}.addRedNoise
...
do
    ...
    tempo2 -gr createRealisation -f $idealtim -corn ${idealtim}.addGauss $i -corn ${idealtim}.addArbitraryDM $i -corn ${idealtim}.addDmVar $i -corn ${idealtim}.addRedNoise;
...
# TA-DA! you now have tim files with simulated DM/RN
